import { nextStepPath } from '../../../../../config/prototype-members-list-add-member-steps.js'
import { PROTOTYPE_COMPLIANCE_SCHEME_SERVICE_NAME } from '../../../../../config/prototype-compliance-scheme-content.js'

const FLASH_KEY = (stepId) => `prototypeMembersListAddMemberErrors:${stepId}`
const VALUES_KEY = (stepId) => `prototypeMembersListAddMemberValues:${stepId}`

// Task-flow chrome: header, phase banner and back link only — no masthead
// navigation, no tabs, no breadcrumbs.
