...
const STEP_ID = 'smallProducerDeclaration'
...
const renderView = (h, pageContent, registrationId, viewModel) =>
  h.view('annualReturn/smallProducer/declaration/view', {
    pageTitle: pageContent.title,
    heading: pageContent.heading,
    intro: pageContent.intro,
    labels: pageContent,
    errorTitle: pageContent.error.title,
    action: pathTo(paths.annualReturnSmallDeclaration, { registrationId }),
    bundleName: 'annualReturnSmallDeclaration.js',
    ...viewModel
  })
...
export const declarationController = {
  get: {
    handler(request, h) {
      const pageContent = content.annualReturnSmallDeclaration(request)
    ...
    options: {
      validate: {
        ...
        failAction: (request, h, err) => {
          ...
          return h
            .redirect(
              pathTo(paths.annualReturnSmallDeclaration, {
    ...
    handler(request, h) {
      ...
      return renderView(h, pageContent, registrationId, {
        ...
        pagePayload: {
          ...
          nextStep: pathTo(paths.annualReturnSmallConfirmation, {
            registrationId
          })
        }
      })
