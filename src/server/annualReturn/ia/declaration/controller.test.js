...
const url = pathTo(paths.annualReturnIaDeclaration, { registrationId: 'reg-1' })
...
describe('#iaDeclaration', () => {
  ...
  test('POST valid renders payload with target submission-submit', async () => {
  ...
  test('GET after a failed POST renders the error summary', async () => {
    const post = await server.inject({ method: 'POST', url, payload: {} })
